...
public class Controller {
    ...
    public List<Item> findItemByCategory(@RequestParam(name = "category_name") String categoryName, @RequestParam(name = "page_index") int pageIndex){
        return itemService.findByCategory(categoryName,pageIndex,2);
    }
